...
const MenuCard = ({ option, index }) => {
  ...
  return (
    <Link href={path}className="bg-white rounded-lg overflow-hidden shadow-md p-4 mb-4 w-60 flex flex-col transform transition-transform duration-300 ease-in-out hover:scale-105">
